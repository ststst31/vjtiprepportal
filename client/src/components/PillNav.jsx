        ...
        >
          ...
          >
            {items.map((item, i) => {
              ...
              const basePillClasses = 'pill-item-link';

              return (
                <li key={item.href} role="none" className="pill-item-li">
      ...
      >
        <ul className="pill-mobile-list">
          {items.map(item => {
            ...
            const linkClasses = 'pill-mobile-link';
